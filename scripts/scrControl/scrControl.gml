...
keyActP = max(keyboard_check_pressed(vk_enter), keyboard_check_pressed(vk_space), keyboard_check_pressed(ord("E")))
keyActR = max(keyboard_check_released(vk_enter), keyboard_check_released(vk_space), keyboard_check_released(ord("E")))